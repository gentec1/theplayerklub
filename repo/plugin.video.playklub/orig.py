...
def correctPVR():
	...
	loginurl   = "http://otttv.co:2095/get.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
	EPGurl     = "http://otttv.co:2095/xmltv.php?username=" + username_text + "&password=" + password_text + "&type=m3u_plus&output=ts"
	...
	choice = xbmcgui.Dialog().ok("[COLOR white]PVR SETUP DONE[/COLOR]",'[COLOR white]We\'ve copied your OTT TV to the PVR Guide[/COLOR]',' ','[COLOR white]This includes the EPG please allow time to populate now click launch PVR[/COLOR]')
